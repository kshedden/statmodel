...
func TestCI2(t *testing.T) {
	...
	// From Python Statsmodels
	pr := [][]float64{
		[]float64{0.11111111, 0.17037037, 0.17037037, 0.17037037,
			0.17037037, 0.17037037, 0.17037037},
		[]float64{0., 0., 0.20740741, 0.20740741,
			0.20740741, 0.20740741, 0.20740741},
		[]float64{0., 0., 0., 0.17777778,
			0.26666667, 0.26666667, 0.26666667},
	}
	se := [][]float64{
		[]float64{0.07407407, 0.08976251, 0.08976251, 0.08976251,
			0.08976251, 0.08976251, 0.08976251},
		[]float64{0., 0., 0.10610391, 0.10610391, 0.10610391,
			0.10610391, 0.10610391},
		[]float64{0., 0., 0., 0.11196147, 0.12787781,
...
func TestCI3(t *testing.T) {
	...
	// From Python Statsmodels
	pr := [][]float64{
		[]float64{0.05, 0.05, 0.10607639, 0.16215278, 0.16215278,
			0.22897714, 0.2958015, 0.2958015, 0.3932537, 0.4907059},
		[]float64{0., 0.05277778, 0.10885417, 0.10885417, 0.16960359,
			0.23642795, 0.23642795, 0.31438971, 0.41184191, 0.41184191},
	}
	se := [][]float64{
		[]float64{0.04873397, 0.04873397, 0.07114208, 0.08597339, 0.08597339,
			0.10174694, 0.11255895, 0.11255895, 0.13106522, 0.13753272},
		[]float64{0., 0.05136219, 0.07274191, 0.07274191, 0.08957865,
			0.10420542, 0.10420542, 0.11863944, 0.13371982, 0.13371982},
	}
